...
function parse_commandline()
    s = ArgParseSettings("Calculate optimal flip angles (α1 and α1) and repetition times (TR1 and TR2) and for dual flip angle R1 and PD measurements")
    ...
    @add_arg_table! s begin
        ...
        "--PDorR1"
            ...
            required = true
            arg_type = String
            range_tester = (x->x=="PD"||x=="R1"||x=="both")
        "--TRmin"
